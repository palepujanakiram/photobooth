...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.chenyeju.FlutterUVCCameraPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_uvc_camera, com.chenyeju.FlutterUVCCameraPlugin", e);
    }
    try {
