...
bool ignored(String path) {
  const patterns = [
    ...
    'photo_capture_uvc_device_helpers.dart',
    'photo_capture_uvc_raster_capture.dart',
    'photo_capture_uvc_shutter_helpers.dart',
    ...
    'process_exit_info_io.dart',
    'native_jpeg_encode_io.dart',
    'strip_compositor_skia.dart',
